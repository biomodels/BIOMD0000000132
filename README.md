...
`pip install git+https://github.com/biomodels/BIOMD0000000132.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000132.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000132 as model`
...
Neurons?_ Figure1(M) rebound spike has been reproduced by MathSBML. The ODE
